...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2023 at 07:55 AM
...
(4, 7, 'Rofiqi Hamim', 'BRI', 370000, '2023-06-21', '21062023 112555bukti1trasnfer.jpeg'),
(5, 6, 'Rofiqi Hamim', 'BRI', 95000, '2023-06-21', '21062023 112737buktitransfer.jpeg');
...
(3, 1, 4, 2, '2023-06-04', 727000, 'Malang', 17000, 'Jl. merbabu, keniten, boyolali, malang 98765', 'JNE Express', 'lunas', 'QWE453'),
...
(6, 1, 3, 2, '2023-06-20', 95000, 'Surabaya', 15000, 'jl. merbabu, patihan kidul, siman 87654', 'JNE Express', 'sudah kirim pembayaran', ''),
(7, 1, 3, 3, '2023-06-21', 370000, 'Surabaya', 15000, 'jl. sekar taman patihan kidul siman surabaya', 'SiCepat\r\n', 'sudah kirim pembayaran', '');
...
(8, 6, 9, 1, 'YVES RYAN SWEET ESCAPE FRAGRANCE MIST', 80000, 250, 250, 80000),
(9, 7, 5, 1, 'Zara Peony Woman', 355000, 90, 90, 355000);
...
(5, 'Zara Peony Woman', 355000, 90, 'peony-woman-90-ml.jpg', 'Parfum ini sangat cocok di pakai oleh wanita yang sering pergi keluar        ', 49),
(6, 'Lelido Victory Man', 165000, 100, 'victory-man-.jpg', 'Parfum dengan wangi yang elegan.        ', 50),
...
(9, 'YVES RYAN SWEET ESCAPE FRAGRANCE MIST', 80000, 250, 'sweet-escape-fragrance-mist-.jpg', 'Parfum dengan keharuman tahan lama.        ', 49);
...
--
ALTER TABLE `pembelian_product`
  MODIFY `id_pembelian_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
